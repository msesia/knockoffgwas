...
This method is equally valid for quantitative and binary phenotypes, making no assumptions about their genetic architectures. Instead, we rely on hidden Markov models of linkage disequilibrium.

For more information, read the accompanying <a target="_blank" href="?">paper</a>:

<p class="comment">
<i>Controlling the false discovery rate in GWAS with diverse and related samples</i><br>
